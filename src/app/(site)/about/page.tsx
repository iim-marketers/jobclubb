    ...
    <>
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-3 leading-7 text-muted-foreground">
              ...
              high-quality and superior way - integrating cost-efficient people,
              better processes and new technologies to connect talent with
              opportunity.
            </p>
      ...
      <Section>
        ...
        <p className="mt-4 max-w-2xl leading-7 text-muted-foreground">
          Additional sectors are planned as JobClubb.com expands, building on
          the same model of sector focus backed by genuine employer
          relationships.
        </p>
