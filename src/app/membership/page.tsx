      ...
      <Section>
        <div className="grid items-stretch gap-6 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-4 text-xs leading-5 text-muted-foreground">
              Paid securely via Razorpay. Renewal reminder 15 days before
              expiry.
            </p>
          </PlanCard>
          ...
          >
            ...
            <p className="mt-4 text-xs leading-5 text-muted-foreground">
              Codes are generated by the JobClubb admin team. Ask your
              institution or your nearest franchise partner.
            </p>
          </PlanCard>
        </div>
